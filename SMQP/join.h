...
void BinaryJoinWD(u64 partyIdx, DBServer& srvs, SharedTable R, u64 RBKeyID, u64 ROrderKeyId, u64 RBPIKeyID, u64 RTagID, std::vector<u64> RCalPIID, 
                SharedTable S, u64 SBKeyID, u64 SOrderKeyId, u64 SBPIKeyID, u64 STagID, std::vector<u64> SCalPIID, SharedTable &T, i64 nout = -1);
