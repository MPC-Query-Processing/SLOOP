...
void CompactionZeroEntity(u64 partyIdx, DBServer& srvs, SharedTable &table, u64 col_id) {
    ...
    for (auto i=0; i<nrows; ++i) {
        pos1.mShares[0](i) = tag.mShares[0](i);
        pos1.mShares[1](i) = tag.mShares[1](i);
        pos2.mShares[0](i) = tag.mShares[0](i) ^ 1;
        pos2.mShares[1](i) = tag.mShares[1](i) ^ 1;
    }
    ...
    u64 compact_size = real_size(0, 0);
